...
class ShowTest extends TestCaseWithAuth
{
    ...
    public function test_get_company_invalid_token()
    {
        $company = Company::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_company_expired_token()
    {
        $company = Company::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_company_user_not_found()
    {
        $company = Company::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_company_company_not_found()
    {
