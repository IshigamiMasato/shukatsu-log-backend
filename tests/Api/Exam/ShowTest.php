...
class ShowTest extends TestCaseWithAuth
{
    ...
    public function test_get_exam_invalid_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $exam = Exam::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_exam_expired_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $exam = Exam::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_exam_user_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $exam = Exam::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_exam_apply_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $exam = Exam::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_exam_exam_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $exam = Exam::factory()->create(['apply_id' => $apply->apply_id]);
