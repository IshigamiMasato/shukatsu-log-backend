...
class DeleteTest extends TestCaseWithAuth
{
    ...
    public function test_delete_final_result()
    {
    ...
    public function test_delete_final_result_invalid_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $finalResult = FinalResult::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_final_result_expired_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $finalResult = FinalResult::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_final_result_user_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $finalResult = FinalResult::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_final_result_apply_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $finalResult = FinalResult::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_final_result_final_result_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $finalResult = FinalResult::factory()->create(['apply_id' => $apply->apply_id]);
