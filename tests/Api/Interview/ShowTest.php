...
class ShowTest extends TestCaseWithAuth
{
    ...
    public function test_get_interview()
    {
    ...
    public function test_get_interview_invalid_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $interview = Interview::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_interview_expired_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $interview = Interview::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_interview_user_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $interview = Interview::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_interview_apply_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $interview = Interview::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_get_interview_interview_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
