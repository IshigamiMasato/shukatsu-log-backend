...
class ShowTest extends TestCaseWithAuth
{
    ...
    public function test_get_apply()
    {
    ...
    public function test_get_apply_invalid_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_apply_expired_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_apply_user_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
    ...
    public function test_get_apply_apply_not_found()
    {
