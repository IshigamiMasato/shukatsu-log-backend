...
class DeleteTest extends TestCaseWithAuth
{
    ...
    public function test_delete_offer_invalid_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $offer = Offer::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_offer_expired_token()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $offer = Offer::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_offer_user_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $offer = Offer::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_offer_apply_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
        $offer = Offer::factory()->create(['apply_id' => $apply->apply_id]);
    ...
    public function test_delete_offer_offer_not_found()
    {
        $apply = Apply::factory()->create(['user_id' => $this->user->user_id]);
